"""Long-lived MCP client over stdio (Node mcp-jarvis1net) in a background asyncio thread."""
...
class McpStdioClient:
    """One subprocess (Node MCP) and one ClientSession for the process lifetime."""
